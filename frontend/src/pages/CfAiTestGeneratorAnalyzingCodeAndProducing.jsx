...
export default function CfAiTestGeneratorAnalyzingCodeAndProducing() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-ai-test-generator-analyzing-code-and-producing-assertions/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-ai-test-generator-analyzing-code-and-producing-assertions', project: 'AITestGenerationPlatform' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-ai-test-generator-analyzing-code-and-producing-assertions/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">AI test generator analyzing code and producing assertions</h1>
