...
export default function CfMutationTestingWithGeneratedMutantVariantsTo() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-mutation-testing-with-generated-mutant-variants-to-assess/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-mutation-testing-with-generated-mutant-variants-to-assess', project: 'AITestGenerationPlatform' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-mutation-testing-with-generated-mutant-variants-to-assess/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Mutation testing with generated mutant variants to assess test quality</h1>
